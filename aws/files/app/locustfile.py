...
class DestinationOfTheWeek(CustomTaskSequence):
    ...
    def task_1400(self):
        ...
        response = self.get(
            "/",  # NOQA
            "1400",  # NOQA
            "(DestinationOfTheWeek) Visit /",  # NOQA
        )
